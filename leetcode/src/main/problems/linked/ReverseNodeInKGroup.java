...
public class ReverseNodeInKGroup {
    ...
    public void test1() {
        ...
        LinkedListTestUtils.assertLinkedListEquals(ListNode.of(2, 1, 4, 3, 5), reverseKGroup(head, 2));
    }

    @Test
    public void test2() {
        LinkedListTestUtils.assertLinkedListEquals(ListNode.of(2, 1), reverseKGroup(ListNode.of(1, 2), 2));
    }
